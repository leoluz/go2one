...
map("n", "<leader>o", ":lua require('telescope.builtin').lsp_document_symbols()<CR>", silent)
map("n", "gr", ":lua require('telescope.builtin').lsp_references()<CR>", silent)
map("n", "gi", ":lua require('telescope.builtin').lsp_implementations()<CR>", silent)
